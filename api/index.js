...
export default async function handler(req, res) {
    ...
    try {
        ...
        // 2. EXACT DEDUCTION CALCULATION (Bina Increment function ke taaki koi glitch na aaye)
        ...
        let rName = receiverData.name || paytm;
        ...
        return res.status(200).json({ 
            status: "success", 
            message: `Payment successful to ${paytm}`,
            data: { transaction_id: txnId, amount: withdrawAmount, receiver: paytm, sender: adminPhone } 
        });
