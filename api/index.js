...
export default async function handler(req, res) {
    ...
    try {
        ...
        const targetNumber = paytm || number; // Support for both payment and deposit API patterns
        ...
        // Find user by either payment api key or deposit api key
        ...
        // FIXED: Prevent self-payment via API
        ...
        // If it's a deposit API, immediately reset the API Key for security
        let newDepKey = null;
        if (isDepositApi) {
        ...
        if (isDepositApi) resData.new_deposit_api_key = newDepKey; // Optional: Send new key in response
